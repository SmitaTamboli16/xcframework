...
enum AEPSharedStateResolution : NSInteger;
...
/// \param barrier If true, the <code>EventHub</code> will only return <code>.set</code> if <code>extensionName</code> has moved past <code>event</code>
///
/// \param resolution The <code>SharedStateResolution</code> to resolve for
///
///
/// returns:
/// A <code>SharedStateResult?</code> for the requested <code>extensionName</code> and <code>event</code>
- (AEPSharedStateResult * _Nullable)getSharedStateWithExtensionName:(NSString * _Nonnull)extensionName event:(AEPEvent * _Nullable)event barrier:(BOOL)barrier resolution:(enum AEPSharedStateResolution)resolution SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// A <code>SharedStateResult?</code> for the requested <code>extensionName</code> and <code>event</code>
- (AEPSharedStateResult * _Nullable)getXDMSharedStateWithExtensionName:(NSString * _Nonnull)extensionName event:(AEPEvent * _Nullable)event barrier:(BOOL)barrier resolution:(enum AEPSharedStateResolution)resolution SWIFT_WARN_UNUSED_RESULT;
...
/// Type representing the resolution of an extension’s <code>SharedState</code>
typedef SWIFT_ENUM_NAMED(NSInteger, AEPSharedStateResolution, "SharedStateResolution", open) {
  AEPSharedStateResolutionLastSet = 0,
  AEPSharedStateResolutionAny = 1,
};
